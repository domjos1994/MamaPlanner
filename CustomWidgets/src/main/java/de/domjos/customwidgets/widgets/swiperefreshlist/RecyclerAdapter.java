...
package de.domjos.customwidgets.widgets.swiperefreshlist;
...
public class RecyclerAdapter extends Adapter<RecyclerAdapter.RecycleViewHolder> {
    ...
    class RecycleViewHolder extends ViewHolder implements View.OnCreateContextMenuListener {
        ...
        RecycleViewHolder(View itemView) {
            ...
            this.mTitle = itemView.findViewById(R.id.lblTitle);
            this.mSubTitle = itemView.findViewById(R.id.lblSubTitle);
            this.ivIcon = itemView.findViewById(R.id.ivIcon);
            this.chkSelector = itemView.findViewById(R.id.chkSelector);
    ...
    public void onBindViewHolder(@NonNull RecycleViewHolder holder, int position) {
        if(data!=null) {
            if(data.get(position)!=null) {
                ...
                holder.mSubTitle.setText(data.get(position).getSubTitle());
    ...
    public void clear() {
        ...
        ListObject obj = new ListObject(this.activity, null);
        obj.setTitle(this.activity.getString(R.string.sys_no_item));
        this.data.add(obj);
