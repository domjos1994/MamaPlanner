    ...
    protected void initControls() {
        try {
            ...
            if(id==0L) {
                ...
                this.toDoList.setCalendar(Converter.convertStringToDate(date, Global.getDateFormat()));
    ...
    private void objectToFields() {
        try {
            ...
            if(this.toDoList.getCalendar() != null) {
                this.txtToDoDeadline.setText(Converter.convertDateToString(this.toDoList.getCalendar().getTime(), Global.getDateFormat().split(" ")[0]));
            }
    ...
    private void fieldsToObject() {
        try {
            ...
            if(!this.txtToDoDeadline.getText().toString().isEmpty()) {
                this.toDoList.setCalendar(Converter.convertStringToDate(this.txtToDoDeadline.getText().toString(), Global.getDateFormat().split(" ")[0]));
            }
